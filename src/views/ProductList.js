...
import { asceFunction } from "../redux/actions/productActions";
...
function ProductList({ addToCart }) {
  ...
  const searchItem = async (e) => {
    ...
    setProduct("");
    await dispatch(searchproduct(setData, searchTerm, data));
    console.log(data);
  };
  ...
  const handleSort = async (name) => {
    ...
    if (name == "Ascending") {
      setDesc("");
      await dispatch(asceFunction(setAsce));
    ...
    <div className="bg-white">
      <div className="flex">
        ...
        <div className="lg:flex-1">
          <div>
            <div className="bg-white">
              <div>
                ...
                <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 lg:mx-52">
                  ...
                  {/* <section
                aria-labelledby="products-heading"
                className="pb-24 pt-6 bg-black w-72"
              >
                <h2 id="products-heading" className="sr-only">
                  Products
                </h2>
          ...
          {/* rendering products */}
          <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 lg:mx-52">
